    ...
    <div class="content container-fluid">
        ...
        <form action="javascript:" method="post" id="item_form" enctype="multipart/form-data">
            ...
            <div class="row g-2">
                            ...
                            @if ($language)
                                <div class="lang_form" id="default-form">
                                    <div class="form-group">
                                        <label class="input-label" for="default_name">{{ translate('Voucher Name') }}
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="input-label"
                                            for="exampleFormControlInput1">{{ translate('Voucher description') }}
                                            ({{ translate('messages.default') }})<span
                                                class="form-label-secondary text-danger" data-toggle="tooltip"
                                                data-placement="right"
                                                data-original-title="{{ translate('messages.Required.') }}"> *
                        ...
                        <div class="card-body">
                            <div class="row g-2 align-items-end">
                                ...
                                <div class="col-sm-6 col-lg-3" id="unit_input">
                                    <div class="form-group mb-0">
                                        <label class="input-label"
                                            for="brand_id">{{ translate('messages.Customer') }}<span
                                                class="input-label-secondary"></span></label>
                                ...
                                <div class="col-sm-6 col-lg-3" id="unit_input">
                                    <div class="form-group mb-0">
                                        <label class="input-label text-capitalize"
                                            for="unit">{{ translate('messages.Customer') }}</label>
                ...
                <div class="col-md-4" id="addon_input">
                    <div class="card shadow--card-2 border-0">
                        <div class="card-header">
                            <h5 class="card-title">
                ...
                <div class="col-md-4" id="voucher_option">
                    <div class="card shadow--card-2 border-0">
                        <div class="card-header">
                            <h5 class="card-title">
                                <span class="card-header-icon"><i class="tio-dashboard-outlined"></i></span>
                                <span>Voucher Option</span>
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="form-group mb-0">
                                <!-- Voucher Options -->
                                <label class="input-label" for="voucher_option">
                                    Options<span class="input-label-secondary"></span>
                                </label>
                                <select name="voucher_option" id="voucher_option" class="form-control">
                                    <option value="">Select Voucher Type</option>
                                    <option value="discount_voucher">Discount Voucher</option>
                                    <option value="gift_voucher">Gift Voucher</option>
                                    <option value="cashback_voucher">Cashback Voucher</option>
                ...
                <div class="col-md-4" id="time_input">
                    <div class="card shadow--card-2 border-0">
                        <div class="card-header">
                            <h5 class="card-title">
                        ...
                        <div class="card-body">
                            <div class="row g-2">
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="branch">Select Branch (Default)*<span
                                                class="input-label-secondary"></span></label>
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="provider">Select Provider (Default)*<span
                                                class="input-label-secondary"></span></label>
                                        <select name="provider" id="provider" data-placeholder="Select Provider"
                                            class="form-control">
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="provider">
                                            Select Discount Type<span class="input-label-secondary"></span>
                                        </label>
                                        <select name="provider" id="provider" data-placeholder="Select Provider"
                                            class="form-control">
                ...
                <div class="col-md-6" id="payment_method">
                    <div class="card shadow--card-2 border-0">
                        <div class="card-header">
                            <h5 class="card-title">
                                <span class="card-header-icon"><i class="tio-credit-card"></i></span>
                                <span>Payment Method</span>
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="form-group">
                                <label class="input-label d-block mb-2">Select Payment Method</label>
                                ...
                                <div class="d-flex gap-3">
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="electronic" name="payment_method" value="electronic"
                                            class="custom-control-input">
                ...
                <!-- Offer Receiving Method -->
                <div class="col-md-6" id="offer_receiving_method">
                    <div class="card shadow--card-2 border-0">
                        <div class="card-header">
                            <h5 class="card-title">
                                <span class="card-header-icon"><i class="tio-gift"></i></span>
                                <span>Offer Receiving Method</span>
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="form-group">
                                <label class="input-label d-block mb-2">Select Offer Receiving Method</label>

                                <div class="d-flex gap-3">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="delivery" name="offer_receiving_method"
                                            value="delivery" class="custom-control-input" checked>
                                        <label class="custom-control-label" for="delivery">Delivery</label>
                                    </div>

                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="takeaway" name="offer_receiving_method"
                                            value="takeaway" class="custom-control-input">
                                        <label class="custom-control-label" for="takeaway">Takeaway</label>
                                    </div>

                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="instore" name="offer_receiving_method"
                                            value="instore" class="custom-control-input">
                                        <label class="custom-control-label" for="instore">In-Store</label>
                                    </div>
                                </div>
                            </div>
                        </div>
