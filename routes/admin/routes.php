...
use App\Http\Controllers\Admin\GroupCustomerController;



Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    Route::resource('businessowners', BusinessOwnerController::class);
    Route::resource('group-customers', GroupCustomerController::class);
